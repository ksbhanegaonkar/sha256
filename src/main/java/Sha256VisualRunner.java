 ...
 */
public class Sha256VisualRunner {

    public static void main(String[] args) throws DecoderException {
        System.out.println(Hex.encodeHexString(hash(Hex.decodeHex("7c122b86287a3ef7eac247e0ad637091ccfecbf85f6213030d9c1f895515d9e6"))));
    }
    ...
    public static byte[] hash(byte[] message) {
        ...
        for (int i = 0, n = words.length / 16; i < n; ++i) {
            ...
            for (int t = 0; t < W.length; ++t) {
                System.arraycopy(TEMP, 0, prev, 0, TEMP.length);
    ...
    //10100100000111110011001011100111
    //01011011111000001100110100011001

    //00011111100000111101100110101011
    //11100000011111000010011001010101
    private static void printTemp(int[] temp, int[] prev) {
        char[] c = {'a','b', 'c','d', 'e', 'f', 'g','h'};
        System.out.println("===============================================");
        for(int i=0;i<8;i++){
            System.out.println(c[i] + " "+Integer.toHexString(prev[i])+" -> "+Integer.toHexString(temp[i])+" | "+prev[i]+" -> "+temp[i] + " | "+Integer.toBinaryString(prev[i])+" -> "+Integer.toBinaryString(temp[i]));
        }
        System.out.println("===============================================");
    }
